            ...
            <div class="col-12 col-sm-6 col-md-3" >
                <div class="info-box mb-3">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $totalalumi }} <small>Orang</small></span>
              ...
              <div class="col-12 col-sm-6 col-md-3" >
                <div class="info-box mb-3">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"> {{ $jumlahpesertalaki }} <small>Orang</small> </span>
              ...
              <div class="col-12 col-sm-6 col-md-3" >
                <div class="info-box mb-3">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"> {{ $jumlahpesertaperempuan }} <small>Orang</small></span>
              ...
              <div class="col-12 col-sm-6 col-md-3" >
                <div class="info-box mb-3">
                  <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-users"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">TOTAL Pesan Saran</span>
                    <span class="info-box-number"> {{$jumlahpesansaran}} <small>Pesan Saran</small></span>
              ...
              <div class="col-12 col-sm-6 col-md-3" >
                <div class="info-box mb-3">
                  <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-users"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">TOTAL Pesan Komentar</span>
                    <span class="info-box-number"> {{$jumlahpesankomentar}} <small>Pesan Komentar</small></span>
